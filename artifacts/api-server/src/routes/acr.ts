...
function serializeConfig(c: AcrConfigRow) {
  return {
    ...
    responseTimeSubweight: c.responseTimeSubweight,
    consistencySubweight: c.consistencySubweight,
    missedChatSubweight: c.missedChatSubweight,
    leadCoverageSubweight: c.leadCoverageSubweight,
...
function serializeAgentScore(s: AcrAgentScoreRow) {
  return {
    ...
    consistencyPct: num(s.consistencyPct),
    totalContactsHandled: s.totalContactsHandled,
    contactsWithLeadStatus: s.contactsWithLeadStatus,
    leadCoveragePct: num(s.leadCoveragePct),
    grade: s.grade,
...
router.put(
  ...
  async (req: Request, res: Response): Promise<void> => {
    ...
    const validationError = validateConfigInput({
      ...
      responseTimeSubweight: b.responseTimeSubweight,
      consistencySubweight: b.consistencySubweight,
      missedChatSubweight: b.missedChatSubweight,
      leadCoverageSubweight: b.leadCoverageSubweight,
